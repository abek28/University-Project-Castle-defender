...
bg1 = pygame.image.load('images/background/bg1.png').convert_alpha()
...
while run:
    ...
    if not game_over:
        ...
        # check game_over
            ...
            #print("start")
            active = False
            labels.draw_text(display, 'GAME OVER!', labels.font70, WHITE, int(DISPLAY_WIDTH/3-10), int(DISPLAY_HEIGHT/2-50))
